  ...
  return (
    ...
    >
      <motion.div
        ...
        className="w-full max-w-[780px] max-h-[600px] flex rounded-[36px] border border-white/80 shadow-2xl overflow-hidden bg-white text-black"
      >
        {/* LEFT SIDEBAR */}
            ...
            {CATEGORIES.map((cat) => {
              ...
              return (
                <button
                  key={cat}
                  onClick={() => setActiveTab(cat)}
                  className={`text-left text-[14px] px-3 py-2 rounded-lg transition-all duration-150 outline-none ${
                    isSelected
